                ...
                <header className="header sticky top-0 bg-white shadow-md flex items-center justify-between px-8 py-02">
                    <h1 className="w-3/12">
                        <a href="/" className='hover:text-purple-400 duration-200 font-bold'>
                            <img src="../images/lmslogo.jpg" alt="LMS Logo" />
                        </a>
                    </h1>
                    ...
                    <div className="w-3/12 flex justify-end">
                        <Link to="/Login.js" className='text-lg font-bold bg-violet-200 hover:bg-purple-400 rounded-md w-32 h-10 text-center items-center px-2 py-1'>
                            Login
                        </Link>
                    </div>
                </header>
